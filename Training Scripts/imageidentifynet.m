...
trainedimageidentifyNet = NetTrain[myimageidentifynet, trainingset, All,
        BatchSize -> 32, LearningRateMultipliers -> {"linear" -> 1, _ -> 0}, ValidationSet -> validationset, TargetDevice -> "GPU", TrainingProgressCheckpointing -> {"File","checkpointimageidentifynet.wlnet"}];
